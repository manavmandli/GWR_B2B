...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
# EMAIL_HOST_USER = 'manavmandli2990@gmail.com' 
# EMAIL_HOST_PASSWORD = 'efmgpvljmlwysvxq'
EMAIL_HOST_USER = 'goldwholesalingandretailing@gmail.com' 
EMAIL_HOST_PASSWORD = 'npnbvrkdljfdnkmi'
